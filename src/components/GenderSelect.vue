<template>
  <div class="gender-select">
    ...
    <UserProfileList
      ...
      :switch-user-label="t.userMenu?.switchUser || 'Switch User'"
      :new-user-label="t.userMenu?.addUser || 'New User'"
      @select="switchToUser"
    />
...
function handleSubmit() {
  ...
  const profileId = profilesStore.createProfile(trimmedName, selectedGender.value)
  profilesStore.switchProfile(profileId)
  userStore.setUser(trimmedName, selectedGender.value)
